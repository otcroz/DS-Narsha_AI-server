...
TeacherImageContent = Namespace('teacher-image-content')

@TeacherImageContent.route('/teacher/image/content')
    ...
    def post(self):
        ...
        completion = openai.ChatCompletion.create(
            ...
            messages=[
                ...
                {"role": "system", "content": "문자는 두 문장 이내로 작성한다. 게시글 내용과 게시글 사진에 관련있는 내용으로 작성한다."},
